...
# Категория: lab — Лабораторный показатель. Файл: kb/glb/lab_reference/glb_lab_<краткое_имя>.md
id: GLB-LAB-NNN
schema_version: 2
title: <Название>
domain: glb
...
# Машиночитаемый слой (docs/schema.md, раздел «lab»):
parameter: "sbp"  # parameter; обязательно для approved
reference_range: {"min": 0, "max": 0}  # object; обязательно для approved
sources:
