...
# Категория: disclaimer — Дисклеймер. Файл: kb/glb/disclaimers/glb_disclaimer_<краткое_имя>.md
id: GLB-DISCLAIMER-NNN
schema_version: 2
title: <Название>
domain: glb
category: disclaimer
...
# Машиночитаемый слой (docs/schema.md, раздел «disclaimer»):
text: "<текст>"  # string; обязательно для approved
applies_to_access_level: ["professional"]  # list[enum(access_level)]; необязательно
sources:
