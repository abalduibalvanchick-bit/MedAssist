...
# Категория: vaccine — Вакцина. Файл: kb/prot/vaccines/prot_vaccine_<краткое_имя>.md
id: PROT-VACCINE-NNN
schema_version: 2
title: <Название>
domain: prot
...
# Машиночитаемый слой (docs/schema.md, раздел «vaccine»):
indications: {"all": [{"symptom": "DIAG-SYMPTOM-002"}, {"param": "sbp", "op": ">=", "value": 180}]}  # condition; обязательно для approved
contraindications: [{"all": [{"symptom": "DIAG-SYMPTOM-002"}, {"param": "sbp", "op": ">=", "value": 180}]}]  # list[condition]; необязательно
schedule: "<текст>"  # string; необязательно
sources:
